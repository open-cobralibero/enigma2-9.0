...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "skins-cobraliberosat.pli/skin.xml" or "PLi-HD/skin.xml"  # SD hardware is no longer supported by the default skin.
